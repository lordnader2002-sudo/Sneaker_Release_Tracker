# file: fetch_release_thedropdate.py
...
SOURCE_URL = "https://thedropdate.com/releases"
SOURCE_NAME = "thedropdate"
...
def extract_rows(soup: BeautifulSoup) -> list[dict[str, Any]]:
    ...
    for a in soup.find_all("a", href=True):
        ...
        href = a["href"]
        if href.startswith("/"):
            href = "https://thedropdate.com" + href
        ...
        rows.append(
            {
                ...
                "imageUrl": extract_image_url(a.parent, base_url="https://thedropdate.com"),
